...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/debo-hack/BOYKA/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1661260546,1736967791,}   
...
if tonumber(user_id) == tonumber(1736967791) then  
var = 'مطور السورس'
...
os.execute('wget https://raw.githubusercontent.com/debo-hack/BOYKA/master/BOYKA.lua')
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/debo-hack/BOYKA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/debo-hack/BOYKA/master/File_Bot/"..file)
if res == 200 then
